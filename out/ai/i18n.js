...
class I18nManager {
    ...
    detectLocale() {
        ...
        const configLocale = daunsConfig.get('locale');
        ...
        try {
            ...
            this.translations = {
                en: {
                    ...
                    'extension.description': 'Detect and display all variables in your code with detailed information',
                    // Commands
                ...
                es: {
                    ...
                    'extension.description': 'Detecta y muestra todas las variables en tu código con información detallada',
                    // Commands
                    ...
                    // Refactoring
                    'refactoring.rename': 'Renombrar Variable en Todo el Espacio de Trabajo',
                    'refactoring.extract': 'Extraer Variable',
                    'refactoring.extractSmart': 'Extraer Variable con Nombres Inteligentes',
                    'refactoring.convert': 'Convertir Declaración de Variable',
                    'refactoring.convertSmart': 'Convertir Variable con Sugerencias Inteligentes',
                    ...
                    // Messages
                    'message.scanComplete': 'Escaneo completado: {{count}} variables encontradas',
                ...
                id: {
                    ...
                    'extension.description': 'Deteksi dan tampilkan semua variabel dalam kode Anda dengan informasi detail',
                    // Commands
                    ...
                    // Messages
                    'message.scanComplete': 'Pemindaian selesai: {{count}} variabel ditemukan',
